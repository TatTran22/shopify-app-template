...
class ShopifyProvider extends ServiceProvider
{
    ...
    {
        $host = str_replace('https://', '', Config::get('app.url'));

        Context::initialize(
            Config::get('shopify.credentials.api_key'),
            Config::get('shopify.credentials.api_secret'),
            ...
            '',
            null,
            (array)Config::get('shopify.custom_domain'),
        );
